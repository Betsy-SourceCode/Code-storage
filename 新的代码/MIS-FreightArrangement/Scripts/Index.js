    ...
    $scope.TOWlgj = function (Laid, tableName) {
        if (tableName == "LA_Order") {
            layer.open({
                ...
                content: "https://192.166.7.241/LandArrange/BasicInfo.aspx?LAId=" + Laid + "&QuanXian=" + 1,
        ...
        if (tableName == "VN_LA_Order") {
            layer.open({
                ...
                btn: ['关闭'], //按钮组
                //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
                content: "https://192.166.7.241/VNLandArrange/BasicInfo.aspx?LAId=" + Laid + "&QuanXian=" + 1,
                btn: function () {//layer.alert('aaa',{title:'msg title'});  点击取消回调
                    layer.close(this);//layer.closeAll();
                }
            });
        ...
        if (tableName == "LK_LA_Order") {
            layer.open({
                ...
                btn: ['关闭'], //按钮组
                //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
                content: "https://192.166.7.241/LKLandArrange/BasicInfo.aspx?LAId=" + Laid + "&QuanXian=" + 1,
                btn: function () {//layer.alert('aaa',{title:'msg title'});  点击取消回调
                    layer.close(this);//layer.closeAll();
                }
            });
