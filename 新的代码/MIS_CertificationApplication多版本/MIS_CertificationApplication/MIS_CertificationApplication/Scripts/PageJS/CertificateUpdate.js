...
app.controller('mycontroller', function ($scope, $compile) {
    ...
    //认证详情界面弹窗  未作废的
    $scope.CertificateMasterDetails = function (CertCode) {
        layer.open({
            type: 2,
            title: '认  证  证  书  明  细',
            skin: 'layui-layer-rim', //加上边框
            area: ['700px', '90%'], //宽高
            content: '../CertificationApplication/CertificateMasterDetails?CertCode=' + CertCode,
    ...
    //认证详情编辑  作废的
    $scope.ModifyCertificateMasterDetails = function (CertCode) {
        layer.open({
            type: 2,
            title: '认  证  证  书  明  细',
            skin: 'layui-layer-rim', //加上边框
